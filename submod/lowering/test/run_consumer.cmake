...
set(ptxsim_consumer_source "${PTXSIM_SOURCE_DIR}/submod/lowering/test/consumer")
...
set(ptxsim_consumer_args
    ...
    "-DCMAKE_PREFIX_PATH=${PTXSIM_VCPKG_PREFIX}"
...
if(NOT ptxsim_configure_result EQUAL 0)
    message(FATAL_ERROR "external lowering consumer configure failed:\n${ptxsim_configure_output}\n${ptxsim_configure_error}")
endif()
...
if(NOT ptxsim_build_result EQUAL 0)
    message(FATAL_ERROR "external lowering consumer build failed:\n${ptxsim_build_output}\n${ptxsim_build_error}")
endif()

execute_process(
    COMMAND "${ptxsim_consumer_build}/build/ptxsim_lowering_external_consumer"
...
if(NOT ptxsim_run_result EQUAL 0)
    message(FATAL_ERROR "external lowering consumer run failed:\n${ptxsim_run_output}\n${ptxsim_run_error}")
endif()
