...
Result<float32_t> tanh_approx(float32_t);
...
Result<float16_t> tanh_approx(float16_t);
Result<float16_t> ex2_approx(float16_t);
Result<bfloat16_t> tanh_approx(bfloat16_t);
Result<bfloat16_t> ex2_approx(bfloat16_t);
