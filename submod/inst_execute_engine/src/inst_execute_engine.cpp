...
// Generated wiring uses the private preparation types above. Runtime semantics,
// resource resolution, predication, and commit protocols remain handwritten.
#include "engine_dispatch.gen.inc"
