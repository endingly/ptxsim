...
available. It owns structured diagnostics, `LoweringContext`, and
`lower_module`. It is installed/exported only as the explicit `lowering`
package component; the default package remains frontend-free.
